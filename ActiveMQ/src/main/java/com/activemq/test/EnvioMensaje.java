...
public class EnvioMensaje {
	public enum UserAction {
		...
		CONFIGURACION("IR A OPCIONES DE CONFIGURACION"), PORTADA("VER PORTADA"), LOGIN(
				"ACCEDER A LA APLICACION"), SUGERENCIA("ENVIAR SUGERENCIA");
	...
	private void sendMessages(Session session, MessageProducer producer) throws JMSException {
		final EnvioMensaje messageSender = new EnvioMensaje();
